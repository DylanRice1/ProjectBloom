 ...
 * @author Dhruv Thota
 */
class OrgToken extends Endpoint
{
    
    private $sql = "SELECT id, passwordHash FROM OrganisationLogin WHERE email = :email";
    private $sqlParams = [];
        ...
        switch (Request::method()) {
            ...
            case 'POST':
               ...
               /* // Verify the provided password
                ...
                // Verify the provided password (plaintext) with the password stored in the database (plaintext)
                if ($_SERVER['PHP_AUTH_PW'] !== $data[0]['passwordHash']) {
                    throw new ClientError(401);
                }
