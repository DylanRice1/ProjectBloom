...
const RegisterForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-500 text-yellow-500">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-xs">
        ...
        <button type="submit" className="bg-yellow-500 hover:bg-yellow-400 text-green-500 hover:text-green-600 py-2 px-4 rounded-md w-full">
          Register
        </button>
      </form>
      <p className="mt-4">
        <Link to="/" className="text-yellow-500 hover:text-yellow-400 flex items-center">
