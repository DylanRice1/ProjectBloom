<?php
class OrgRegister extends Endpoint
{
    private $sqlOrganisation = "INSERT INTO OrganisationLogin (email, passwordHash) VALUES (:email, :passwordHash)";
    private $sqlCheckEmail = "SELECT COUNT(*) AS count FROM OrganisationLogin WHERE email = :email";
    private $sqlParams = [];
